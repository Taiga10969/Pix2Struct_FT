...
from models.processing_utils import ProcessorMixin
...
class Pix2StructProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor, tokenizer):
        #print("Pix2StructProcessor [info] image_processor : ", image_processor) # Pix2StructImageProcessor
        #print("Pix2StructProcessor [info] type(image_processor) : ", type(image_processor)) # <class 'transformers.models.pix2struct.image_processing_pix2struct.Pix2StructImageProcessor'>
        #print("Pix2StructProcessor [info] tokenizer : ", tokenizer)   # T5TokenizerFast
        #print("Pix2StructProcessor [info] type(tokenizer) : ", type(tokenizer))   # <class 'transformers.models.t5.tokenization_t5_fast.T5TokenizerFast'>
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if not self.image_processor.is_vqa:
            # add pixel_values
            encoding_image_processor, my_info = self.image_processor(
        ...
        return encoding_image_processor, my_info
